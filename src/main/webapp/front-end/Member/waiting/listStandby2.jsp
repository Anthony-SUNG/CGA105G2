        ...
        <main role="main " class="col-md-9 ml-sm-auto col-lg-10 px-md-4 container ">
            <div>
                <div class="input-group-text">
                    <p class="form-control pt-5" style="background-color: rgb(255, 201, 123); color: black;">候位表</p>
                </div>
                <div class="p-0 flex-grow-1" id="tablenumber" style="display: none">
                    <div class="btn-group btn-group-toggle flex-grow-1" data-toggle="buttons">
                        ...
                        <label class="btn btn-secondary" id="btmoff">
                            <input type="radio" name="options" id="option2" checked>off
                        </label>
                    </div>
                </div>
                <div class="btn-group btn-group-toggle" id="tablewait">
                    ...
                    <section class="section p-0 " id="faq2" style="overflow-y: scroll; height: 300px">
                                ...
                                <div class="col-12 p-0">
                                    <article class="faq p-0">
                                        ...
                                        <header class="faq-header" data-toggle="collapse"
                                                data-target="#faq2-item-<%=standby.getStaId() %>" aria-expanded="false">
                                            <table class="table table-striped m-0">
                                                <tbody class="code_tbody">
                                                <tr class="text-center">
                                                    <td class="col-5"><%=standby.getStaPhone() %>
                                                    </td>
                                                    <td><%=standby.getStaName() %>
                                                    </td>
                                        ...
                                        <div class="faq-body collapse row mx-auto" id="faq2-item-${standbyVo.staId}"
                                            ...
                                            <form METHOD="post" id=noticeStandby
                                                ...
                                                <input type="hidden" name="staId" value="<%=standby.getStaId() %>">
                                                <input type="hidden" name="staStatus"
                                                       value="<%=standby.getStaStatus() %> ">
                                                <input type="hidden" name="action" value="delete">
                                            </form>
                                            <form METHOD="post" id="checkStandby"
                                                  ACTION="<%=request.getContextPath()%>/standby">
                                                <input class="btn btn-outline-info" data-value="come" onclick=""
                                                       type="submit" value="報到d">
                                                <input type="hidden" name="staId" value="<%=standby.getStaId() %>">
