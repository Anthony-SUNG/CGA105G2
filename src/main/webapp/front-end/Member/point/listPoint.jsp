...
<%--                     <Form method="post" action="${pageContext.request.contextPath}/Member/MemberServlet"> --%>
                    <h1 class="h2 mt-5">💰剩餘點數<span class="lrp_text_count">${Member.memPoint} <dfn>points</dfn></span></h1>
