            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <ol style="list-style: none;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 border">
                                <div class="position-relative snipimage"
                            	 ...
                            	 <img src="https://i.pinimg.com/564x/07/c4/72/07c4720d19a9e9edad9d0e939eca304a.jpg" alt="" style="width: 90%;height: 70%; border-radius: 60%;border: 1px solid rgb(255, 216, 87);">
                            		</c:if>
                                ...
                                <div class="mt-8">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a href="/CGA105G2/LonginServlet?action=MemberPage&SearchMemberId=${followMem.member.memId}">
                                            <span class="mb-1" style="font-size:22px;font-weight: 700;">${followMem.member.memName} </span>
                                        </a>
                                    </div>
                    ...
                    <li>
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-7 border mb-10" style="text-align: center; height: 30px;background-color: rgb(216, 233, 253);"></div>
                        </div>
                    </li>
                </ol>
