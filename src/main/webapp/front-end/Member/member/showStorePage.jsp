                    ...
                    <div class="col-8">
                        ...
                        <c:if test="${subslist.size() == 0}">
				                        ...
				                        <input type="hidden" name="subMemId" value="${member.memId}" >
				                            <button class="button button-like" type="submit" onclick="insertSubs()" id="insertSubs">
		                ...
		                <c:if test="${subslist.size() != 0 }">    	
				                        ...
				                        <button class="button button-like liked" type="submit" onclick="deleteSubs()" id="deleteSubs">
				                                <i class="fa fa-heart"></i>
...
<!-- 						===============================Ajax測試========================= -->
<!-- 						<form method="post" action="/CGA105G2/MyFavoriteServlet" name="" > -->
<%-- 				                        <input type="hidden" name="subStoreId" value="${store.storeId}" id="storeId"> --%>
<%-- 				                        <input type="hidden" name="subMemId" value="${member.memId}" id="memId"> --%>
<!-- 				                            <button class="button button-like" type="submit" onclick="insertSubs()" id="insertSubs"> -->
<!-- 				                                <i class="fa fa-heart"></i> -->
<!-- 				                                <span id="subscribe_store">已訂閱</span> -->
<!-- 				                            </button> -->
...
//     let url = "insertSubs.jsp";
    
//     let xhr = new XMLHttpRequest();
//     xhr.open("post", url, true);
//     xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
//     xhr.send("storeId=" + storeId + "&memId=" +memId);
//   }
//   console.log(storeId);
//   console.log(memId);
</script>
                ...
                <div>
                    ...
                    <div>
                            ...
                            <input type="hidden" name="action" value="Member_order_button">
       						...
       						<input type="hidden" type="submit" value="詩傑-會員訂位">
                        </FORM>
                    </div>
                    <div>
                        <a href="">
                    ...
                    <li >
                        <div class="col-12" style="padding: 15px 0px 0px 0px;">
                            <div class="col-12" style="background-color: white;">
                                ...
                                <img class="rounded-circle" src="${pageContext.request.contextPath}/LonginServlet?action=getOtherMemberPhoto&memId=${articlelist.memId}"  style="width:60px;">
                                </c:if>
                            	<c:if test="${empty articlelist.member.memPic}">
                            	 <img class="rounded-circle" src="https://i.pinimg.com/564x/07/c4/72/07c4720d19a9e9edad9d0e939eca304a.jpg" alt=""  style="width:60px;"/>
                           		 </c:if>
                                    ...
                                    <div class="col-12 d-flex flex-column"><span
                                            class="name font-weight-bold">${articlelist.member.memName}</span><span><fmt:formatDate value="${articlelist.artTime}" pattern="yyyy-MM-dd" /></span>
                                    </div>
								</a>
...
<script>
    function initMap() {
        var uluru = {lat: ${store.storeMap.split(',')[0].substring(1)}, lng: ${store.storeMap.split(',')[1].substring(0,10)}};
