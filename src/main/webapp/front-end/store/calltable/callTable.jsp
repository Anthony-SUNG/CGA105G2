        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <%@ page import="java.sql.Timestamp" %>
                <%@ page import="com.waiting.model.service.StandbyService" %>
                    <%@ page import="com.waiting.model.pojo.Standby" %>
                        ...
                        <% String selectedOption=(String) session.getAttribute("selectedOption"); String sts=(String)
                            request.getAttribute("onOff"); %>
                                                        ...
                                                        <label class="input-group-text col-2">
                                                            <button class="btn btn-secondary form-control  p-0"
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="35"
                                                                    height="35" fill="currentColor" class="bi bi-search"
                                                            ...
                                                            <button class="btn btn-secondary form-control  p-0"
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="38"
                                                                    ...
                                                                    <path fill-rule="evenodd"
                                                                        ...
                                                                        id="mainIconPathAttribute" stroke="#4162c3">
                                                                    </path>
                                                                </svg>
                                                            </button>
                                                    ...
                                                    <form>
                                                        <div class="p-0 flex-grow-1" id="tablenumber"
                                                            ...
                                                            <div class="btn-group btn-group-toggle flex-grow-1"
                                                                ...
                                                                <form>
                                                                    <label class="btn btn-secondary active" id="btmon"
                                                                        for="option1">
                                                                        <input type="radio" name="options" id="option1"
                                                                            value="on" <%="on" .equals(selectedOption)
                                                                            ? "checked" : "" %>>
                                                                        on
                                                                    </label> <label class="btn btn-secondary"
                                                                        id="btmoff" for="option2">
                                                                        <input type="radio" name="options" id="option2"
                                                                            value="off" checked <%="off"
                                                                            .equals(selectedOption) ? "checked" : "" %>>
                                                                        off
                                                                    </label>
                                                                </form>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 p-0">
                                                                        <article class="faq p-0"
                                                                            id="selectStandByResult"></article>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </section>
            ...
            `;
                                        ...
                                        <script>
                                            ...
                                            console.log(`staStatus1:\${onOff}`);
                                            


                                            let onOff2 = <%=sts%>;
                                            // onOff2=${sts}
                                            console.log("sts2" + onOff2);
                                                                    ...
                                                                    `<div id="staHeader-\${data[i].staId}">
                                                                                        <header class="faq-header"
                                                                                            ...
                                                                                            <table
                                                                                                ...
                                                                                                <tbody
                                                                                                    ...
                                                                                                    <tr  class="text-center">
                                                                                                        <td class="fs-2 col-5 p-2 py-3 my-auto align-middle">
                                                                                                            \${data[i].staPhone}
                                                                                                        </td>
                                                                                        ...
                                                                                        <div class="radio-buttons-group w-100 justify-content-center " >
                                                                                            ...
                                                                                            <form METHOD="post"
                                                                                                ...
                                                                                                <input type="hidden" name="staId"  id="callStaId"     value="\${data[i].staId}">
                                                                                            ...
                                                                                            <form METHOD="post"
                                                                                                  id="checkStandby"
                                                                                                  ACTION="<%=request.getContextPath()%>/standby" class="d-block">
                                                                                                <input type="hidden" name="staId"  id="checkStaId"     value="\${data[i].staId}">
                                            ...
                                            function checkMem() {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (data) {
                                                        ...
                                                        // console.log($('#checkStandby').serialize());
                                                        console.log(data);
                                                        $(`#staHeader- \${staId}`).css("display", "none");
                                                        $("#option1").trigger('click');
                                                        let html = "";
                                                        for (let i = 0; i < data.length; i++) {
                                                            ...
                                                            html = ` <article class="faq p-0">
            <header class="faq-header" data-toggle="collapse"
                    data-target="#faq1-item-\${data[i].renId}" aria-expanded="false">
                <table class="table table-striped m-0">
                    <tbody class="code_tbody">
                    <tr class="text-center">
                        <td class="col-4">A0</td>
                        <td class="col-4">\${data[i].staName}</td>
                        <td class="col-4">\${data[i].staNumber}位</td>
                    </tr>
                    </tbody>
                </table>
                <div class="faq-toggle" style="display: none">
            ...
            <div class="faq-body collapse" id="faq1-item-\${data[i].renId}">
                <div class="card-body pt-0 pb-1" data-mh="gift-vouchers">
                    <div>
                        <form METHOD="post" ACTION="/CGA105G2/TableServlet" class="d-flex col-12">
                            <select class="btn btn-dark p-0 w-75 cantab" name="table">
                            ...
                            <button class="btn btn-dark p-0 w-25">✔</button>
                            <input type="hidden" name="action" value="totable" class="d-none">
                            <input type="hidden" name="toid" value="\${data[i].renId}" class="d-none">
                        </form>
                    </div>
                    <div id="orderD\${data[i].renId}"></div>
                    <div class="border-lighter border-top my-2"></div>
                    <div class="d-flex align-items-center justify-content-between mt-2">
                        // <div class="text-dark">TOTAL</div>
                        // <div class="price-value fs-3">$\${data[i].PRICE}</div>
                    </div>
                    <form METHOD="post" ACTION="/CGA105G2/TableServlet">
                        <input type="hidden" name="date" value="${date}" class="d-none">
                        <input type="hidden" name="totime" value="${totime}" class="d-none">
                        <input type="hidden" name="toid" value="\${data[i].renId}" class="d-none">
                        <button class="btn p-0 w-100 " style="background-color: rgba(253, 72, 72, 0.65); color: black;">\${p}</button>
                        <input type="hidden" name="table" value="\${data[i].TABLE}" class="d-none">
                        <input type="hidden" name="action" value=\${to} class="d-none">
                    </form>
                </div>
            </div>
