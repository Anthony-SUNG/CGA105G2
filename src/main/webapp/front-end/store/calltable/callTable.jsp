                            ...
                            <%-- %> --%>
                                ...
                                <body>
                                    ...
                                    <%@ include file="/front-end/store/01h/headeronly.jsp" %>
                                        <!-- header end -->
                                        <!-- <button class="btn btn-dark" onclick="getDateTime()">test</button> -->
                                        <!-- main -->
                                        <div class="p-0">
                                            <!--        篩選-->
                                                            ...
                                                            <div class="p-0 flex-grow-1" id="tablenumber"
                                                                ...
                                                                <div class="btn-group btn-group-toggle flex-grow-1"
                                                                    ...
                                                                    <label class="btn btn-secondary active" id="btmon">
                                                                        ...
                                                                        id="btmoff"> <input type="radio" name="options"
                                                                            id="option2" checked>off
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </form>
                                                                        ...
                                                                        `<div id="staHeader-\${data[i].staId}">
                                                                                        ...
                                                                                        <div class="radio-buttons-group w-100 justify-content-center " >
                                                                                            ...
                                                                                            <form METHOD="post"
                                                                                                ...
                                                                                                <input type="hidden" name="staId" value="\${data[i].staId}">
