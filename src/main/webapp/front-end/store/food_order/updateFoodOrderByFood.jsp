          ...
          <div>
            <form METHOD="post" action="<%=request.getContextPath()%>/front-end/store/food_order/food_order.do" class="p-4 ">
              ...
              <div class="form-group row">
                ...
                <input name="mealName" type="text" class="form-control" id="meal" value="${mealVO.mealName}">
              ...
              <div class="form-group row">
                ...
                <input name="mealPrice" type="text" class="form-control" id="money" value="${mealVO.mealPrice}">
              ...
              <input class="form-group  btn btn-danger btn-block fs-5 mt-10" type="submit" value="送出" style="border-radius: 30px;">
            </form>
          </div>
        </div>
      </div>
