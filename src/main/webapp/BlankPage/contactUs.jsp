            ...
            <div class="section-content container">
                <div>
                    <div class="col-12 col-lg-12 mb-14 mb-lg-0 text-center">
                        <small class="fs-1 font-family-secondary text-uppercase font-weight-bold letter-spacing-caption text-muted text-center">We
                            answer within 24 hours </small>
                        ...
                        <form action="/CGA105G2/SendMailServlet" class="row mt-17" method="POST">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <input type="submit" value="發送訊息" class="btn btn-primary btn-lg btn-block fs-5">
                                </div>
                            </div>
                        </form>
                    </div>
