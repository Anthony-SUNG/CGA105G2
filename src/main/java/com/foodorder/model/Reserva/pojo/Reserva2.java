...
public class Reserva2 {
  ...
  private Integer renFprice;
	...
	public Reserva2(Integer renId, Integer renStatus, Integer renTable) {
		super();
		this.renId = renId;
	...
	public Reserva2(Integer storeId, Integer memId, String renName, String renPhone, String renTime, Date renDate,
