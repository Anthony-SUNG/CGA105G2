...
//		dao.insert(reservaDetail2);
		// getByPK
		// (1)REN_ID:查詢訂單編號=1有哪些餐點
//		List<ReservaDetail> list1 = dao.getByPK(1, "renId");
//		
//		System.out.println("訂單編號1的餐點如下:");
//		for (ReservaDetail e : list1) {
//			System.out.println("餐點編號:" + e.getMealId());
//			System.out.println("數量:" + e.getRdQuantity());
//			System.out.println("單價:" + e.getPdPrice());
//			System.out.println("*******************************************");
//		}
//		System.out.println("*******************************************");
//		System.out.println("*******************************************");
