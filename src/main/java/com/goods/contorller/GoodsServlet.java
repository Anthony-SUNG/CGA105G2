...
//			Timestamp goodsTime = null;
//			try {
//				goodsTime = Timestamp.valueOf(req.getParameter("goodsTime").trim());
//			} catch (NumberFormatException e) {
//				goodsTime = null;
//				errorMsgs.add("請填日期");
//			}
//			
//			Timestamp goodsRtime = null;
//			try {
//				goodsRtime = Timestamp.valueOf(req.getParameter("goodsRtime").trim());
//			} catch (NumberFormatException e) {
//				goodsRtime = null;
//				errorMsgs.add("請填日期");
//			}
