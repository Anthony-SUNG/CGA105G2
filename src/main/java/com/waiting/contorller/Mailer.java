...
public class Mailer extends Common {
    // sender
    ...
    public void send(String name, String phone, String mail, String message) {
        ...
        try {
            ...
            logger.error(ErrorTitle.UNKNOWN_TITLE.getTitle("AddressException"),e);
        } catch (MessagingException e) {
            logger.error(ErrorTitle.UNKNOWN_TITLE.getTitle("MessagingException"),e);
        }
